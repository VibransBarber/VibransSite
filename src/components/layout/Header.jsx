    ...
    return (
        <header className="flex items-center justify-between border-b border-white/10 px-6 py-4 lg:px-20 bg-background-dark">
            ...
            <nav className="hidden md:flex flex-1 justify-center gap-10">
                <a className="text-slate-300 hover:text-primary text-sm font-medium transition-colors" href="#services">Services</a>
                <a className="text-slate-300 hover:text-primary text-sm font-medium transition-colors" href="#barbers">Barbers</a>
                <a className="text-slate-300 hover:text-primary text-sm font-medium transition-colors" href="#gallery">Gallery</a>
                <a className="text-slate-300 hover:text-primary text-sm font-medium transition-colors" href="#memberships">Memberships</a>
            </nav>
